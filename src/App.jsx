...
import { DesiGaadiApp } from './components/DesiGaadiApp';
...
export default function App() {
  return (
    <div className="min-h-screen bg-[#07090e] text-white flex flex-col selection:bg-amber-400 selection:text-black">
      ...
      {/* Sleek Top Header */}
      <header className="sticky top-0 z-30 w-full backdrop-blur-xl bg-[#07090e]/90 border-b border-white/8 px-4 sm:px-8 py-3.5 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-mono">
              असली गानों का देसी गाड़ी म्यूजिक प्लेयर (Auto • Truck • Bus • Taxi • Tractor)
            </p>
          </div>
        </div>
